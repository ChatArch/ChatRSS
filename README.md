...
| 真实 Zulip / Discourse / Mattermost trigger + 回帖案例 | 已在 `zhihong.oray` 用统一 actor `RexWang` 验证 | [真实事件案例](docs/real-world-cases.md) / [Mattermost](docs/platforms/mattermost.md) |
